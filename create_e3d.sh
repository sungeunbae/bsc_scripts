...
# Env Vars (Optional): N_PROC, EMOD3D_BIN
...
# FIX: Use Env Var for Binary if set, otherwise fallback to BSC path
DEFAULT_BIN="$BINDIR/emod3d-mpi_v${EMOD3D_VER}"
EMOD3D_BIN="${EMOD3D_BIN:-$DEFAULT_BIN}"

# FIX: Use Env Var for N_PROC (passed from SLURM), default to 512
N_PROC="${N_PROC:-512}"
...
echo "✅ Generated $OUT_PAR (n_proc=$N_PROC)"
